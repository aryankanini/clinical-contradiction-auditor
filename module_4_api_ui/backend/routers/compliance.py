...
@router.get("/findings/{finding_id}/reproducibility", response_model=ReproducibilityOut)
def check_reproducibility(
	...
	return service.reproducibility(session, finding_id)


@router.post("/findings/{finding_id}/verification", response_model=VerificationOut)
def record_verification(
	...
	return service.record_verification(session, finding_id, payload, principal)
